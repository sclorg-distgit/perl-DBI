...
%{?perl_default_filter}
%global __requires_exclude %{?__requires_exclude|%__requires_exclude|}^%{?scl_prefix}perl\\(RPC::\\)

%if ( 0%{?rhel} && 0%{?rhel} < 7 )
%filter_from_requires /perl(RPC::)/d
%filter_setup
%endif
...
%changelog
* Mon Feb 17 2014 Jitka Plesnikova <jplesnik@redhat.com> - 1.630-4
- Updated conditions to not require optional BRs (MLDBM, SQL::Statement) for SCL
- Resolves: rhbz#1064855

* Thu Feb 13 2014 Jitka Plesnikova <jplesnik@redhat.com> - 1.630-3
- Updated conditions to work properly for non-RHEL systems
- Resolves: rhbz#1064855

* Tue Nov 26 2013 Jitka Plesnikova <jplesnik@redhat.com> - 1.630-2
- Add a security warning about use of RPC::PlClient (bug #1030578)

* Tue Nov 19 2013 Jitka Plesnikova <jplesnik@redhat.com> - 1.630-1
- 1.630 bump
